...
$userID = $_POST["userID"];
$manageShiftDate = $_POST["manageShiftDate"];
$comment = $_POST["comment"];

$manageShiftGroup = array('userID'=>$userID,'manageShiftDate'=>$manageShiftDate,
                                'comment'=>$comment);
$manageShiftObj->add_manage_shift($manageShiftGroup);
?>
<!DOCTYPE html>
<html lang="en">
<head>
